...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { description: @sell.description, email: @sell.email, name: @sell.name, price: @sell.price, title: @sell.title }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { description: @sell.description, email: @sell.email, name: @sell.name, price: @sell.price, title: @sell.title }
    assert_redirected_to sell_path(assigns(:sell))
  end
